...
def upgrade() -> None:
    ...
    op.add_column(
        "committees", sa.Column("director_image_url", sa.String(1024), nullable=True)
    )
    op.add_column(
        "committees", sa.Column("contact_email", sa.String(255), nullable=True)
    )
    op.add_column(
        "committees",
        sa.Column("joint", sa.Boolean(), nullable=False, server_default="false"),
    )
    op.add_column(
        "committees",
        sa.Column("double", sa.Boolean(), nullable=False, server_default="false"),
    )
