...
class Delegate(Base):
    ...
    first_committee: Mapped[str | None] = mapped_column(String(255))
    second_committee: Mapped[str | None] = mapped_column(String(255))
    third_committee: Mapped[str | None] = mapped_column(String(255))
