# this file was generated by Google Gemini AI
...
class PydanticDateTimeTZRange:
    ...
    def __get_pydantic_core_schema__(
        ...
        def validate(value: Any, info: ValidationInfo) -> Any:
            ...
            raise ValueError(
                f"Invalid format for TSTZRANGE object. Got type: {type(value)}"
            )
        ...
        def serialize(value: Any) -> dict:
            ...
            return {
                "lower": (
                    lower_attr.isoformat()
                    if isinstance(lower_attr, datetime)
                    else lower_attr
                ),
                "upper": (
                    upper_attr.isoformat()
                    if isinstance(upper_attr, datetime)
                    else upper_attr
                ),
